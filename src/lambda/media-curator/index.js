    ...
    return await monitorPerformance(async () => {
        ...
        try {
            ...
            if (pexelsKey || pixabayKey) {
                ...
                console.warn('⚠️ Real downloads will not work with test keys');
        ...
        console.log(`📊 Download success rate: ${Math.round((realDownloads / totalAssets) * 100)}%`);
        ...
        try {
            ...
            if (mediaAsset && mediaAsset.url && !mediaAsset.url.includes('placeholder')) {
                try {
                    ...
                    const {
                        generateS3Paths
                    } = require('/opt/nodejs/s3-folder-structure');
