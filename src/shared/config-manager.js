...
class ConfigManager {
    ...
    loadFromEnvironmentVariables() {
        ...
        const envMappings = {
            ...
            'TTS_VOICE_STYLE': 'audio.tts.voice.style',
            'TTS_USE_GENERATIVE': 'audio.tts.generativeSettings.useGenerativeEngine',
            'TTS_STABILITY': 'audio.tts.generativeSettings.stability',
            'TTS_SIMILARITY': 'audio.tts.generativeSettings.similarity',
