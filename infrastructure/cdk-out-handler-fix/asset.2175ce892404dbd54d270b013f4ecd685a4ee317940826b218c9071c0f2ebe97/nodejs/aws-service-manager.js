...
const { DynamoDBClient, QueryCommand, PutItemCommand, UpdateItemCommand, DeleteItemCommand, ScanCommand, GetItemCommand } = require('@aws-sdk/client-dynamodb');
 ...
 */
const getDynamoDBItem = async (tableName, key) => {
  try {
...
const invokeLambda = async (functionName, payload, invocationType = 'RequestResponse') => {
  try {
    ...
    return { success: true, invocationType };
