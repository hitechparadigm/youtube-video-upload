...
async function generateEnhancedScript(requestBody, _context) {
  return await monitorPerformance(async () => {
    ...
    // ALSO create actual script file in proper 02-script/ location
    try {
      ...
      console.log(`📝 Created actual script file: ${scriptS3Key}`);
    } catch (uploadError) {
      console.error('❌ Failed to create script file:', uploadError.message);
    }
