...
/**
 * Quick fix for YouTube Publisher - Remove shared layer dependencies
 */

const fs = require('fs');

// Create a simplified YouTube Publisher that works without shared layers
const simplifiedYouTubePublisher = `/**
...
fs.writeFileSync('src/lambda/youtube-publisher/index.js', simplifiedYouTubePublisher);

console.log('✅ YouTube Publisher updated with simplified version');
console.log('📋 Changes made:');
console.log('   - Removed all shared layer dependencies');
console.log('   - Simplified metadata creation process');
console.log('   - Fixed parameter order issues');
console.log('   - Direct AWS SDK usage only');
console.log('');
console.log('🎯 This should resolve the metadata creation failure and achieve 7/7 success rate');